    ...
    def AdelantarHora(self,hora=0,minutos=0,segundos=0):
        ...
        if(self.__hora>=24):
            ...
            if(self.__dia==30 and self.__mes==4 or self.__mes==5 or self.__mes==6 or self.__mes==9 or self.__mes==11):
                self.__dia=1
                self.__mes+=1
            elif(self.__dia==31 and self.__mes==1 or self.__mes==3 or self.__mes== 7 or self.__mes==8 or self.__mes==10):
                self.__dia=1
                self.__mes+=1
            elif(self.__dia==31 and self.__mes==12):
                self.__año+=1
                self.__dia=1
                self.__mes=1
            elif(self.__dia==28 and  self.__mes==2):
                if(self.__año%4==0 and self.__año%100==0 and self.__año%400==0):
                 ...
                 hora+=self.__hora
                 self.__hora=int(hora)-24
            elif(self.__dia==29 and  self.__mes==2):
                self.__mes+=1
                self.__dia=1